...
@section('title', 'Nouvelle rentrée scolaire')
@section('breadcrumb', 'Nouvelle rentrée scolaire')

@section('content')

<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 p-8">
        <h1 class="text-xl font-bold text-gray-800 mb-6">Nouvelle rentrée scolaire</h1>

        <form method="POST" action="{{ route('admin.rentree-scolaire.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3" maxlength="500"
                          ...
                          class="w-full border border-gray-200 rounded-xl px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('description') }}</textarea>
            </div>
