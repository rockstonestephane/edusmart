...
@section('breadcrumb', 'Modifier la valeur')

@section('content')

<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 p-8">
        <h1 class="text-xl font-bold text-gray-800 mb-6">Modifier la valeur</h1>

        <form method="POST" action="{{ route('admin.valeurs.update', $valeur->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <textarea name="description" required rows="3" maxlength="500"
                          ...
                          class="w-full border border-gray-200 rounded-xl px-4 py-2
                                 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('description', $valeur->description) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <select name="couleur"
                    ...
                    <option value="{{ $value }}" {{ old('couleur', $valeur->couleur) === $value ? 'selected' : '' }}>
                        {{ $label }}
                    </option>
                    @endforeach
                </select>
